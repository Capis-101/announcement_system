...
export default function TeacherDashboard() {
  ...
  const handleAddComment = (post) => {
    ...
    const newComments = [...(post.comments || []), { user: currentUser, text }];

    updateAnnouncement(post.id, { comments: newComments });
            ...
            <div key={post.id} style={styles.postCard}>
              <div style={{ flex: 1 }}>
                ...
                <div style={{ marginTop: "10px" }}>
                  ...
                  <button onClick={() => handleAddComment(post)} style={styles.button}>
                    Comment
                  </button>
                </div>
              </div>
